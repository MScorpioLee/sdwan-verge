...
grep -q "block in quick on en0 proto { tcp udp } from any to <physical_ip> port 30000:48999" <<<"$PLAN_OUTPUT"
...
grep -q "nat_active=" <<<"$STATUS_OUTPUT"
grep -q "nat_capacity=" <<<"$STATUS_OUTPUT"
