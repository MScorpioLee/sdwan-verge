...
assert_contains "list latency_target 'Cloudflare|http://cp.cloudflare.com/generate_204'" "$CONFIG"
...
assert_contains "test_sites" "$CORE"
assert_contains "latency_target" "$CORE"
assert_contains "curl -L" "$CORE"
...
assert_contains "Latency test targets" "$VIEW"
assert_contains "Test sites" "$VIEW"
